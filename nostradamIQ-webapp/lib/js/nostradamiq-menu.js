...
function toggleGiveData() {
  if (giveDataOn) { // Hide give-data
    ...
    $('#give-data').html("<div id='give-data'>DO YOU KNOW OF HAVE SOME INTERESTING DATA?<br>We are happy to visualize Your, or any other Data for anybody, or privately!<br>We build nostradamIQ so that it is incredibally easy to add more data sources - We support various data formats and are happy to help you convert your non-geo dataformat like csv, exel, txt and so on... Open or Your Online Data-Sources are also welcome!<br><a href='mailto:info@nostradamiq.org?subject=nostradamIQ Data Suggestion&amp;body=I have some cool Data for you to include in nostradamIQ!\n\nFormat:____________\nSource:___________(If not an oline source, please attach the data!)\nWhy is this interesting?\nSuggested Name:____________\nOrigin to be credited:__________\n'>Please contact us!</a><br>If you feel like coding yourself, see <a href='https://github.com/nupic-community/nostradamIQ/tree/master/nostradamIQ-webapp' target='_blank'>our source-code</a> and <a href='https://github.com/nupic-community/nostradamIQ/pulls' target='_blank'>make a PR!</a></div>"); 
